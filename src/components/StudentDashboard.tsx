...
const studentWorkspaceImage = '/assets/images/students-study.jpg';
      ...
      <main className="portal-workspace">
        ...
        <section className="student-hero" aria-labelledby="dashboard-title">
          ...
          <div className="student-hero-panel">
            <SafeImage src={studentWorkspaceImage} alt="Students studying together for examination preparation" loading="eager" />
