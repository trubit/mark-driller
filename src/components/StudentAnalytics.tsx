...
const analyticsHeroImage = '/assets/images/cbt-practice.jpg';
      ...
      <main className="portal-workspace">
        <section className="analytics-hero" aria-labelledby="analytics-title">
          ...
          <div className="analytics-score-panel">
            <SafeImage src={analyticsHeroImage} alt="Student using a laptop for CBT exam preparation" loading="eager" />
